...
<x-dash.list-card
    :filter-action="platform_route('admin.journals.editions.index', $journal)"
    :paginator="$editions"
    item-label="issues"
>
    <x-slot:filterStart>
        ...
        @if ($hasActiveFilters)
            <x-dash.button variant="secondary" :href="platform_route('admin.journals.editions.index', $journal)" data-dash-partial-link>Reset</x-dash.button>
        @endif
    </x-slot:filterStart>
    <x-slot:filterEnd>
        <x-dash.button
    ...
    @if ($hasActiveFilters)
        <x-slot:pills>
            <x-dash.filter-pills
                ...
                :reset-url="platform_route('admin.journals.editions.index', $journal)"
            />
        </x-slot:pills>
    @endif
    <x-slot:header>
